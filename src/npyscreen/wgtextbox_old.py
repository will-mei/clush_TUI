...
class TextfieldBase(widget.Widget):
        ...
        if self.editing:
            if self.value:
                if isinstance(self.value, str):
                    _str_with = char_width_tools.str_width(self.value)
                    ...
                    _str_with = char_width_tools.str_width(value_to_use_for_calculations)
                else:
    ...
    def get_char_under_current_curor(self):
        try:
    ...
    #        char_under_cur = ' '
        ...
        char_under_cur = self.get_char_under_current_curor()
        char_under_cur_width = char_width_tools.get_width_of_char(char_under_cur)
        if char_under_cur_width == 2:
    ...
    def find_width_of_char(self, ch):
        return char_width_tools.get_width_of_char(ch)
...
class Textfield(TextfieldBase):
    ...
    def h_cursor_left(self, input):
        ...
        _step = char_width_tools.get_width_of_char(self.get_char_under_current_curor())
